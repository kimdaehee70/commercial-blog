...
// ── [PSEO-PHONE-FALLBACK-01] / [PSEO-HUB-PHONE-FALLBACK-02] ──
//   extractTel / formatTel / resolvePhone 은 lib/pseo/phone.js 로 이동했다.
//   허브(index.js)가 같은 규칙을 써야 하므로 지역 정의를 남기지 않는다.
//   로직은 이동만 했고 변경 없음 — 이 페이지의 렌더 결과는 동일하다.
