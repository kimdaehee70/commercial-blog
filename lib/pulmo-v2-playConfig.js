// ╔══════════════════════════════════════════════════════════╗
// ║ pulmo-v2-playConfig.js — 호흡기내과 V2 Purpose 7섹션 FLOW  ║
// ║ ★ 4섹션(treatmentDecision) = decisionAxis 분기 지점        ║
// ║   exam(3종)    : 검사 선택 기준                            ║
// ║   disease(9종) : 원인확인→검사→약물→관리(수술은 위임)      ║
// ║ ⚠ 관측 전. FREEZE 아님.                                   ║
// ╚══════════════════════════════════════════════════════════╝

export const PULMO_V2_FLOW_ENGINE = {
  industry: 'pulmo',
  version: 'v2-purpose',
  ...
  blockKeywords: [
    ...
    '포경', '전립선',
    '어린이집',
    // 소화기 이식 차단 (인접 내과 — 검사명 혼입 방지)
    '위내시경', '대장내시경', '용종', '장 세척액', '역류성식도염',
    // 흉부외과 수술 상세 차단 (호흡기내과 = 내과. 수술은 위임 수준만)
    '절개', '전신마취', '개흉', '봉합', '수술 방법', '수술 과정', '입원 기간', '폐 절제',
    // 후기형 잔재 차단 (V2는 정보형)
    ...
    '강력 추천', '꼭 받으세요', '정상입니다', '이상 없습니다', '폐암입니다', '진단됩니다',
    '사망률', '생존율',
    // AI 포화
...
export default PULMO_V2_FLOW_ENGINE;
