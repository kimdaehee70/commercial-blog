...
export const FILM_CAT_INFO_BLOCKS = {
  ...
  // [S143 · FILM-COMMON-BLOCK-DOMINANCE-01A] 방문필름 전용 door 오버라이드.
  //   FILM_INFO_BLOCKS.door 원형 무접촉 → 현관문필름(infoKey:"door")은 기존 블록 유지.
  //   items 축 = 고객 판단 변수(개체수·범위·통일·거주). 공정 토큰 미사용.
  방문필름: {
    door: {
      title: "방문 확인 사항",
      items: [
