...
export const FUNERAL_PRACTICAL_ASSETS = {
  intake: {
    ...
    sentences: [
      ...
      { t: "사망진단서는 이후 여러 행정 절차에 사용될 수 있으므로, 발급받을 때 필요한 부수를 확인해 두는 것이 좋습니다.", themeIds: ["DEATH_TYPE_DOC", "POST_DEATH_ADMIN"] },
  ...
  guestGuide: {
    ...
    sentences: [
      ...
      { t: "멀리서 오는 조문객에게는 빈소 위치와 함께 이동 경로를 미리 확인할 수 있도록 안내해 두는 것도 방법입니다.", themeIds: ["FACILITY_INTAKE"] },
  ...
  familyTask: {
    ...
    sentences: [
      ...
      { t: "장례 기간에는 가족이 번갈아 자리를 지키게 되므로 교대 순서를 첫날에 정해 두는 편이 낫습니다.", themeIds: [] },
      { t: "담당 장례지도사와는 입관 시간, 발인 시간, 화장 예약 시각을 하나씩 확인해 두는 것이 좋습니다.", themeIds: ["CREM_TIMING"] },
