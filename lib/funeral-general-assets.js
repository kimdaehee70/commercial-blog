...
export const FUNERAL_PRACTICAL_ASSETS = {
  intake: {
    ...
    label: "접수 · 첫날",
    sentences: [
      { t: "임종 직후에는 사망진단서 또는 사체검안서를 먼저 받아 두어야 이후 절차를 진행할 수 있습니다." },
      { t: "사망진단서는 이후 여러 행정 절차에 사용될 수 있으므로, 발급받을 때 필요한 부수를 확인해 두는 것이 좋습니다." },
      { t: "빈소가 정해지면 가까운 가족과 연락이 닿아야 할 분들에게 빈소 위치와 호실을 먼저 알립니다." },
      { t: "부고를 보내기 전에 연락할 분들을 명단으로 한 번 정리해 두면 같은 사람에게 두 번 연락하거나 빠뜨리는 일을 줄일 수 있습니다." },
      { t: "장례 기간 동안 가족이 계속 자리를 지켜야 하는 상황에 대비해 교대할 순서를 미리 정해 둘 수 있습니다." },
    ],
  },
  ...
  encoffinPractical: {
    ...
    label: "안치 ~ 입관",
    sentences: [
      { t: "고인은 빈소에 바로 모시는 것이 아니라 안치를 거친 뒤 입관 절차로 이어집니다." },
      { t: "입관에 함께할 가족의 범위는 가족끼리 미리 상의해 두면 진행 시간을 준비하기가 수월합니다." },
      { t: "고인에게 입혀 드릴 옷이나 함께 넣을 물건이 있다면 입관 전에 미리 준비해 담당 장례지도사에게 전달합니다." },
      { t: "입관 예정 시간이 정해지면 함께할 가족에게 시간을 미리 알려 참여 여부를 확인해 둡니다." },
    ],
  },
  ...
  guestGuide: {
    ...
    label: "조문객 안내",
    sentences: [
      { t: "부고를 전할 때 빈소 호실과 발인 일시를 함께 적어 두면 조문객이 다시 묻지 않아도 됩니다." },
      { t: "멀리서 오는 조문객에게는 빈소 위치와 함께 이동 경로를 미리 확인할 수 있도록 안내해 두는 것도 방법입니다." },
      { t: "조문은 분향 또는 헌화 중 한 가지를 택해 하며, 두 가지를 모두 해야 하는 것은 아닙니다." },
      { t: "조의금을 받은 기록은 그날그날 정리해 두어야 나중에 답례를 준비할 때 다시 찾는 수고를 덜 수 있습니다." },
    ],
  },
  ...
  familyTask: {
    ...
    label: "상주 · 가족이 챙기는 부분",
    sentences: [
      { t: "상주는 조문을 받는 자리를 지키는 사람이므로, 바깥일 연락을 맡을 가족을 따로 정해 두면 부담이 나뉩니다." },
      { t: "장례 기간에는 가족이 번갈아 자리를 지키게 되므로 교대 순서를 첫날에 정해 두는 편이 낫습니다." },
      { t: "담당 장례지도사와는 입관 시간, 발인 시간, 화장 예약 시각을 하나씩 확인해 두는 것이 좋습니다." },
      { t: "영정으로 쓸 사진은 인화가 필요하므로 가능한 한 이른 시점에 골라 두어야 합니다." },
      { t: "고인의 신분증과 가족관계를 확인할 수 있는 서류는 행정 절차에 반복해서 쓰이므로 한곳에 모아 둡니다." },
    ],
  },
  ...
  departPractical: {
    ...
    label: "발인 · 이후",
    sentences: [
      { t: "발인 시각은 화장 예약 시각에 맞춰 정해지므로, 예약이 확정된 뒤에 가족 일정을 맞추는 순서가 됩니다." },
      { t: "발인 당일에는 빈소를 정리하고 나가야 하므로 짐을 전날 밤에 미리 챙겨 두면 움직임이 수월합니다." },
      { t: "함께 이동할 가족의 차량과 인원을 전날 정리해 두어야 당일 아침에 나누는 시간이 줄어듭니다." },
      { t: "장례가 끝난 뒤에도 사망신고와 각종 해지 절차가 남으므로, 처리할 일을 목록으로 적어 두면 놓치지 않습니다." },
    ],
  },
  ...
  funeralForm: {
    ...
    label: "장례 형태",
    sentences: [
      { t: "가족장으로 정했다면 부고를 보낼 때 조문을 정중히 사양한다는 뜻을 함께 적어 두는 경우가 많습니다." },
      { t: "장례 형태는 고인의 뜻과 가족의 사정에 따라 정하는 것이며, 정해진 정답이 있는 것은 아닙니다." },
      { t: "장례 형태를 정한 뒤에는 선택한 장례 방식에 따라 이후 필요한 절차와 일정을 하나씩 확인합니다." },
    ],
  },
};
