...
② 위치·접근: 어디에 있고 어떻게 가는지.${hasFacts ? `` : ` 주차 확인이 필요한 이유와 함께.`}
...
⑤ 장례지도사 연결: ${hasFacts ? `장례 절차 진행` : `시설 정보만으로 결정되지 않는 부분(빈소 규모 판단·절차 진행)`}을 담당 장례지도사가 맡는다는 점으로 자연 연결. 화장장 관련 내용은 [확인된 시설 정보]에 화장장 항목이 있을 때만 쓴다.
