...
- 허용 작업은 세 가지다: \u2460 문장 순서 배열 \u2461 어미·조사 조정 \u2462 같은 장면의 두 문장 연결.
- \u2605 문장을 새로 만들지 않는다. 위 문장 밖의 사실·설명·예시·부연을 쓰지 않는다.
- \u2605 위에 제공된 문장은 하나도 빼지 않고 모두 사용한다. 일부만 고르거나 요약하지 않는다.
...
- \u2605 이 단락은 유가족이 무엇을 하게 되는지에 대한 일반 안내다.
  위 [최상위 규칙]의 금지(권고 금지·행동 권유 금지·확인 유도 금지)는
  [확인된 시설 정보]의 값에 대한 것이며, 이 단락의 문장에는 적용되지 않는다.
  제공된 문장이 권고형이면 권고형 그대로 쓴다.
- 제공된 문장이 전부다. 분량을 늘리지 않는다.
`;
}
