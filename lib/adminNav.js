// lib/adminNav.js
// v1.1 [OBS-ADMIN-USABILITY-01] 상단 '자동관측' 1줄 제거 → 상단 7개.
// - '관측'(/admin/observations) 하나가 관측 업무영역을 대표한다.
//   '기존관측 / 자동관측' 세부 기능은 lib/observationLayout.js 의 좌측 레일이 소유한다.
// - /admin/auto-observe 라우트·페이지는 삭제하지 않는다(진입점만 좌측 레일로 재배치).
// - 비운 자리는 채우지 않는다. 상단은 매일 쓰는 업무영역만.
//
...
export const ADMIN_NAV = [
  ...
  // OBS-ADMIN-USABILITY-01: 관측 업무영역 대표. 기존관측/자동관측은 좌측 레일(observationLayout.js).
