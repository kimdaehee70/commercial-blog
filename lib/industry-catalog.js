...
export const INDUSTRY_CATALOG = [
  ...
  {
    // [세션56] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
    id: "electricrepair", name: "전기수리", category: "생활서비스", status: "review", enabled: false, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  },
  {
    ...
    id: "shaman", name: "무속 상담", category: "기타", status: "review", enabled: false,
    icon: "🔵",
