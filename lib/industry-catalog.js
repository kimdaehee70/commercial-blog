...
export const INDUSTRY_CATALOG = [
  ...
  },
  {
    ...
    id: "tax", name: "세무사", category: "전문서비스", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  },
  {
    ...
    id: "labor", name: "노무사", category: "전문서비스", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  },
  {
    ...
    id: "administrative", name: "행정사", category: "전문서비스", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  // ── 외식업 ─────────────────────────────────────────────────
  {
    id: "restaurant", name: "음식점", category: "외식업", status: "review", enabled: true, version: "v1",
  ...
  {
    id: "chinese", name: "중식", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "korean", name: "한식", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "snack", name: "분식", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "japanese", name: "일식", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "western", name: "양식", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "chicken", name: "치킨", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "meat", name: "고깃집", category: "외식업", status: "review", enabled: true,
  ...
  {
    id: "cafe", name: "카페", category: "외식업", status: "review", enabled: true,
  ...
  },
  {
    ...
    id: "moving", name: "이사업체", category: "생활서비스", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  },
  {
    ...
    id: "interior", name: "인테리어", category: "건설·시공", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  },
  {
    ...
    id: "dobae", name: "도배", category: "건설·시공", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  {
    // [세션55] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
    id: "systemair", name: "시스템에어컨", category: "건설·시공", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  },
  {
    ...
    id: "leakdetect", name: "누수탐지", category: "생활서비스", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  {
    // [세션56] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
    id: "homefix", name: "집수리", category: "생활서비스", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  {
    // [세션56] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
    id: "electricrepair", name: "전기수리", category: "생활서비스", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
    icon: "⚡", summary: "누전점검 · 차단기점검 · 차단기교체 · 누전차단기교체 · 분전함점검 · 콘센트교체 · 스위치교체 · LED교체 · 센서등교체 · 조명설치 · 전등안들어옴",
    description: "누전·차단기·콘센트·스위치·조명·센서등 등 생활전기 점검·교체를 전기수리 업체 화자 정보형(발생원인·점검위치·증상·확인사항·관리방법)으로 안내합니다(개발 중 · 관측 전).",
  },
  {
    // [세션56] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
  ...
  {
    // [세션56] ⬜ v2-pilot(관측 중) — 발행·관측 데이터 확보 후 배지 재판정.
    id: "bathroom", name: "욕실리모델링", category: "건설·시공", status: "review", enabled: true, verified: true, version: "v2-pilot", hasPhysicalStore: false,
  ...
  // ── 실버케어 ────────────────────────────────────────────────
  {
    id: "daycare", name: "주간보호센터", category: "실버케어", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  {
    id: "homecare", name: "방문요양", category: "실버케어", status: "review", enabled: true, hasPhysicalStore: false, verified: true, version: "v2-new",
    icon: "🔵", summary: "장기요양등급 · 방문요양 비용(본인부담금) · 방문요양 신청방법 · 가족요양 · 방문요양 vs 요양원 · 병원 퇴원 후 돌봄 · 방문요양센터 선택기준",
    description: "방문요양·재가 돌봄 콘텐츠(개발 중 · 관측 전).",
  },
  {
    id: "welfarecare", name: "복지용구", category: "실버케어", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  {
    id: "seniorgoods", name: "노인용품", category: "실버케어", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  {
    id: "funeral", name: "상조", category: "실버케어", status: "review", enabled: true, hasPhysicalStore: false, verified: true, version: "v2-new",
  ...
  // ── 부동산 ─────────────────────────────────────────────────
  {
    id: "realestate", name: "부동산", category: "부동산", status: "review", enabled: true, verified: true, version: "v2-new",
  ...
  // ── 기타 ───────────────────────────────────────────────────
  {
    id: "flower", name: "꽃배달", category: "기타", status: "review", enabled: true, hasPhysicalStore: false,
  ...
  },
  {
    ...
    id: "shaman", name: "무속 상담", category: "기타", status: "review", enabled: true,
    icon: "🔵",
