...
export const INDUSTRY_CATALOG = [
  ...
  },
  {
    ...
    // [세션146] done:true — FILM INTENT 10 cat / 33종 CLOSE. 표시 전용(enabled·status 무영향).
    id: "film", name: "인테리어필름", category: "건설·시공", status: "dev", enabled: false, verified: false, version: "v2-pilot", done: true, hasPhysicalStore: false,
