...
export const FUNERAL_FAQ_DATA = [
  ...
  { q: "빈소는 어떻게 정하나요?", a: "예상 조문객 수를 기준으로 빈소 규모를 정합니다. 식당·주차·안치 시설을 함께 확인합니다.", intent: "hall" },
  ...
  { q: "장례식장은 무엇을 기준으로 고르나요?", a: "예상 조문객 수에 맞는 빈소 규모가 우선이고, 주차 대수와 식당 좌석이 다음 기준입니다. 화장장까지의 거리도 발인 당일 이동에 영향을 줍니다.", intent: "hall" },
  { q: "빈소 예약은 언제 하나요?", a: "안치 장소가 정해지는 시점에 함께 진행합니다. 조문 시작일이 정해져야 식당·인력 준비가 이어집니다.", intent: "hall" },
