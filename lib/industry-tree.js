...
// [NURSINGHOME-OPEN 2026-09-22] 실버케어 그룹 — 요양원 1종만. 서버 INDUSTRY_KEYS(me/store.js) 동반 등록.
//   daycare·homecare 등은 catalog enabled:false → 미노출(검증 후 여기 한 줄 추가).
export const ONBOARD_SILVER = [
  { key: "nursinghome", label: "요양원", badge: "신규" },
];
...
export const INDUSTRY_GROUPS = [
  ...
  { key: "silver",  label: "실버케어", emoji: "🧓",
    items: ONBOARD_SILVER },
];
