...
export const ONBOARD_GENERAL = [
  // [RESTAURANT-OPEN-GATE-01 2026-09-15] 분식점 → 음식점. badge 제거.
  //   전문점 2단 트리(industry-tree §restaurant 계열)로 종류 선택 후 해당 cat 메뉴만 노출.
  //   카페는 계속 숨김. 확장 7계열(korean/chinese/…)은 catalog enabled:false 유지.
...
export const ONBOARD_PROFESSIONAL = [
  ...
  { key: "tax", label: "세무사", badge: "신규" },
  { key: "labor", label: "노무사", badge: "신규" },
  { key: "administrative", label: "행정사", badge: "신규" },
];
...
// [SHAMAN-FINAL-OPEN-CHECK-01] 기타 그룹 — 비정형 업종 수용. 무속 상담 첫 등록.
export const ONBOARD_ETC = [
  { key: "shaman", label: "무속 상담", badge: "신규" },
];
