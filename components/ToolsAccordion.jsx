...
// [v40] 저장 게이트 prop(onRequireAuth/isAuthed) 통과.

import dynamic from "next/dynamic";

const PhotoEditorPage = dynamic(() => import("../pages/photo-editor"), { ssr: false });

export default function ToolsAccordion({ onRequireAuth, isAuthed }) {
  return (
    <div style={{ marginTop: 0 }}>
      <PhotoEditorPage onRequireAuth={onRequireAuth} isAuthed={isAuthed} />
    </div>
  );
}
